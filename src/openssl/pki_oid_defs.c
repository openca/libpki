...
OID_INIT_SIG sigs_table[] = {
	...
	{ 0, OPENCA_ALG_SIGS_EXP_DILITHIUM3_RSA_SHA256_OID, OPENCA_ALG_SIGS_EXP_DILITHIUM3_RSA_SHA256_NAME, OPENCA_ALG_SIGS_EXP_DILITHIUM3_RSA_SHA256_DESC, NID_sha256, NID_undef, 0 },
	{ 0, OPENCA_ALG_SIGS_EXP_DILITHIUM3_ECDSA_SHA256_OID, OPENCA_ALG_SIGS_EXP_DILITHIUM3_ECDSA_SHA256_NAME, OPENCA_ALG_SIGS_EXP_DILITHIUM3_ECDSA_SHA256_DESC, NID_sha256, NID_undef, 0 },
	...
	{ 0, OPENCA_ALG_SIGS_EXP_DILITHIUM5_ECDSA_SHA384_OID, OPENCA_ALG_SIGS_EXP_DILITHIUM5_ECDSA_SHA384_NAME, OPENCA_ALG_SIGS_EXP_DILITHIUM5_ECDSA_SHA384_DESC, NID_sha384, NID_undef, 0 },
...
int PKI_X509_OID_init() {
	...
	while (sig != NULL && sig->oid != NULL) {
		...
		if (sig->pkey_nid == NID_undef) {
			...
			} else if (!strncmp(sig->oid, OPENCA_ALG_SIGS_EXP_DILITHIUM3_RSA_SHA256_OID, strlen(OPENCA_ALG_SIGS_EXP_DILITHIUM3_RSA_SHA256_OID))) {
				sig->pkey_nid = OBJ_txt2nid(OPENCA_ALG_PKEY_EXP_COMP_EXPLICIT_DILITHIUM3_RSA_OID);
			} else if (!strncmp(sig->oid, OPENCA_ALG_SIGS_EXP_DILITHIUM3_ECDSA_SHA256_OID, strlen(OPENCA_ALG_SIGS_EXP_DILITHIUM3_ECDSA_SHA256_OID)) ||
					   !strncmp(sig->oid, OPENCA_ALG_SIGS_EXP_DILITHIUM3_ED25519_OID, strlen(OPENCA_ALG_SIGS_EXP_DILITHIUM3_ED25519_OID)) ||
					   !strncmp(sig->oid, OPENCA_ALG_SIGS_EXP_DILITHIUM5_ECDSA_SHA384_OID, strlen(OPENCA_ALG_SIGS_EXP_DILITHIUM5_ECDSA_SHA384_OID)) ||
