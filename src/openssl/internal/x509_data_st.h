...
typedef LIBPKI_X509_CINF	X509_CINF;
typedef LIBPKI_X509		X509;

typedef LIBPKI_X509_REQ_INFO	X509_REQ_INFO;
typedef LIBPKI_X509_REQ		X509_REQ;

typedef LIBPKI_X509_CRL_INFO	X509_CRL_INFO;
typedef LIBPKI_X509_CRL		X509_CRL;

typedef LIBPKI_X509_ALGOR	X509_ALGOR;

typedef LIBPKI_X509_EXTENSION	X509_EXTENSION;
