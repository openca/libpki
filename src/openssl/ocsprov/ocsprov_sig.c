...
// Code Derived from Entrust's OQS provider
...
// Context management
static OSSL_FUNC_signature_newctx_fn ocsprov_sig_newctx;
static OSSL_FUNC_signature_freectx_fn ocsprov_sig_freectx;
static OSSL_FUNC_signature_dupctx_fn ocsprov_sig_dupctx;

// Signature operations
static OSSL_FUNC_signature_sign_init_fn ocsprov_sig_sign_init;
static OSSL_FUNC_signature_sign_fn ocsprov_sig_sign;

// Signature verification operations
static OSSL_FUNC_signature_verify_init_fn ocsprov_sig_verify_init;
static OSSL_FUNC_signature_verify_fn ocsprov_sig_verify;

// Digest Sign operations
static OSSL_FUNC_signature_digest_sign_init_fn ocsprov_sig_digest_sign_init;
static OSSL_FUNC_signature_digest_sign_update_fn
    ocsprov_sig_digest_signverify_update;
static OSSL_FUNC_signature_digest_sign_final_fn ocsprov_sig_digest_sign_final;

// Digest Verify operations
static OSSL_FUNC_signature_digest_verify_init_fn ocsprov_sig_digest_verify_init;
static OSSL_FUNC_signature_digest_verify_update_fn
    ocsprov_sig_digest_signverify_update;
static OSSL_FUNC_signature_digest_verify_final_fn ocsprov_sig_digest_verify_final;

// Signature context parameter management
static OSSL_FUNC_signature_get_ctx_params_fn ocsprov_sig_get_ctx_params;
static OSSL_FUNC_signature_gettable_ctx_params_fn ocsprov_sig_gettable_ctx_params;
static OSSL_FUNC_signature_set_ctx_params_fn ocsprov_sig_set_ctx_params;
static OSSL_FUNC_signature_settable_ctx_params_fn ocsprov_sig_settable_ctx_params;

// Signature context MD parameter management
static OSSL_FUNC_signature_get_ctx_md_params_fn ocsprov_sig_get_ctx_md_params;
static OSSL_FUNC_signature_gettable_ctx_md_params_fn
    ocsprov_sig_gettable_ctx_md_params;
static OSSL_FUNC_signature_set_ctx_md_params_fn ocsprov_sig_set_ctx_md_params;
static OSSL_FUNC_signature_settable_ctx_md_params_fn
    ocsprov_sig_settable_ctx_md_params;
...
static void *ocsprov_sig_newctx(void *provctx, const char *propq)
{
...
static int ocsprov_sig_setup_md(PROV_OQSSIG_CTX *ctx, const char *mdname,
                            const char *mdprops)
{
...
static int ocsprov_sig_signverify_init(void *vpoqs_sigctx, void *voqssig,
                                   int operation)
{
...
static int ocsprov_sig_sign_init(void *vpoqs_sigctx, void *voqssig,
                             const OSSL_PARAM params[])
{
    OQS_SIG_PRINTF("OQS SIG provider: sign_init called\n");
    return ocsprov_sig_signverify_init(vpoqs_sigctx, voqssig, EVP_PKEY_OP_SIGN);
}

static int ocsprov_sig_verify_init(void *vpoqs_sigctx, void *voqssig,
                               const OSSL_PARAM params[])
{
    OQS_SIG_PRINTF("OQS SIG provider: verify_init called\n");
    return ocsprov_sig_signverify_init(vpoqs_sigctx, voqssig, EVP_PKEY_OP_VERIFY);
}
 ...
 */
static int ocsprov_sig_sign(void *vpoqs_sigctx, unsigned char *sig, size_t *siglen,
                        size_t sigsize, const unsigned char *tbs, size_t tbslen)
{
    ...
    size_t classical_sig_len = 0, ocsprov_sig_len = 0;
    ...
    if (is_composite) {
        ...
        for (i = 0; i < oqsxkey->numkeys; i++) {
            ...
            if (get_oqsname_fromtls(name)) { // PQC signing
                ocsprov_sig_len = oqsxkey->oqsx_provider_ctx.oqsx_qs_ctx.sig
                                  ->length_signature;
                buf = OPENSSL_malloc(ocsprov_sig_len);
                if (OQS_SIG_sign(oqs_key, buf, &ocsprov_sig_len, final_tbs,
                ...
                ocsprov_sig_len = oqsxkey->oqsx_provider_ctx.oqsx_evp_ctx->evp_info
                                  ->length_signature;
                buf = OPENSSL_malloc(ocsprov_sig_len);
                const EVP_MD *classical_md;
                int digest_len;
                ...
                if (name[0] == 'e') { // ed25519 or ed448
                    ...
                    if ((EVP_DigestSignInit(evp_ctx, NULL, NULL, NULL,
                                            oqs_key_classic)
                         <= 0)
                        || (EVP_DigestSign(evp_ctx, buf, &ocsprov_sig_len,
                    ...
                    if ((EVP_PKEY_CTX_set_signature_md(classical_ctx_sign,
                                                       classical_md)
                         <= 0)
                        || (EVP_PKEY_sign(classical_ctx_sign, buf, &ocsprov_sig_len,
                                          digest, digest_len)
                            <= 0)) {
                        ERR_raise(ERR_LIB_USER, ERR_R_FATAL);
                        OPENSSL_free(name);
                    ...
                    if (ocsprov_sig_len > oqsxkey->oqsx_provider_ctx.oqsx_evp_ctx
            ...
            if (i == 0) {
                compsig->sig1->data = OPENSSL_memdup(buf, ocsprov_sig_len);
                compsig->sig1->length = ocsprov_sig_len;
                compsig->sig1->flags
                    = 8; // set as 8 to not check for unused bits
            } else {
                compsig->sig2->data = OPENSSL_memdup(buf, ocsprov_sig_len);
                compsig->sig2->length = ocsprov_sig_len;
                compsig->sig2->flags
                    = 8; // set as 8 to not check for unused bits
            }
        ...
        ocsprov_sig_len = i2d_CompositeSignature(compsig, &sig);

        CompositeSignature_free(compsig);
        OPENSSL_free(final_tbs);
    } else if (OQS_SIG_sign(oqs_key, sig + index, &ocsprov_sig_len, tbs, tbslen,
    ...
    *siglen = classical_sig_len + ocsprov_sig_len;
...
static int ocsprov_sig_verify(void *vpoqs_sigctx, const unsigned char *sig,
...
static int ocsprov_sig_digest_signverify_init(void *vpoqs_sigctx,
                                          ...
                                          int operation)
{
    ...
    if (!ocsprov_sig_signverify_init(vpoqs_sigctx, voqssig, operation))
        return 0;

    if (!ocsprov_sig_setup_md(poqs_sigctx, mdname, NULL))
        return 0;
...
static int ocsprov_sig_digest_sign_init(void *vpoqs_sigctx, const char *mdname,
                                    void *voqssig, const OSSL_PARAM params[])
{
    OQS_SIG_PRINTF("OQS SIG provider: digest_sign_init called\n");
    return ocsprov_sig_digest_signverify_init(vpoqs_sigctx, mdname, voqssig,
                                          EVP_PKEY_OP_SIGN);
}

static int ocsprov_sig_digest_verify_init(void *vpoqs_sigctx, const char *mdname,
                                      void *voqssig, const OSSL_PARAM params[])
{
...
int ocsprov_sig_digest_signverify_update(void *vpoqs_sigctx,
...
int ocsprov_sig_digest_sign_final(void *vpoqs_sigctx, unsigned char *sig,
                              size_t *siglen, size_t sigsize)
{
     ...
     * are ignored. Defer to ocsprov_sig_sign.
     */
    if (sig != NULL) {
        /*
    ...
    if (poqs_sigctx->mdctx != NULL)
        return ocsprov_sig_sign(vpoqs_sigctx, sig, siglen, sigsize, digest,
                            (size_t)dlen);
    else
        return ocsprov_sig_sign(vpoqs_sigctx, sig, siglen, sigsize,
                            poqs_sigctx->mddata, poqs_sigctx->mdsize);
}

int ocsprov_sig_digest_verify_final(void *vpoqs_sigctx, const unsigned char *sig,
                                size_t siglen)
{
    PROV_OQSSIG_CTX *poqs_sigctx = (PROV_OQSSIG_CTX *)vpoqs_sigctx;
    unsigned char digest[EVP_MAX_MD_SIZE];
    ...
    if (poqs_sigctx->mdctx) {
        ...
        return ocsprov_sig_verify(vpoqs_sigctx, sig, siglen, digest, (size_t)dlen);
    } else
        return ocsprov_sig_verify(vpoqs_sigctx, sig, siglen, poqs_sigctx->mddata,
                              poqs_sigctx->mdsize);
}

static void ocsprov_sig_freectx(void *vpoqs_sigctx)
{
...
static void *ocsprov_sig_dupctx(void *vpoqs_sigctx)
{
    ...
    *dstctx = *srcctx;
    ...
    return dstctx;
err:
    ocsprov_sig_freectx(dstctx);
    return NULL;
}

static int ocsprov_sig_get_ctx_params(void *vpoqs_sigctx, OSSL_PARAM *params)
{
    PROV_OQSSIG_CTX *poqs_sigctx = (PROV_OQSSIG_CTX *)vpoqs_sigctx;
    OSSL_PARAM *p;
...
ocsprov_sig_gettable_ctx_params(ossl_unused void *vpoqs_sigctx,
                            ossl_unused void *vctx)
{
    OQS_SIG_PRINTF("OQS SIG provider: gettable_ctx_params called\n");
    return known_gettable_ctx_params;
}
static int ocsprov_sig_set_ctx_params(void *vpoqs_sigctx, const OSSL_PARAM params[])
{
    PROV_OQSSIG_CTX *poqs_sigctx = (PROV_OQSSIG_CTX *)vpoqs_sigctx;
    const OSSL_PARAM *p;
    ...
    if (p != NULL) {
        ...
        if (propsp != NULL
            ...
            return 0;
        if (!ocsprov_sig_setup_md(poqs_sigctx, mdname, mdprops))
            return 0;
    }
...
static const OSSL_PARAM *ocsprov_sig_settable_ctx_params(ossl_unused void *vpsm2ctx,
...
static int ocsprov_sig_get_ctx_md_params(void *vpoqs_sigctx, OSSL_PARAM *params)
{
    PROV_OQSSIG_CTX *poqs_sigctx = (PROV_OQSSIG_CTX *)vpoqs_sigctx;
...
static const OSSL_PARAM *ocsprov_sig_gettable_ctx_md_params(void *vpoqs_sigctx)
{
    PROV_OQSSIG_CTX *poqs_sigctx = (PROV_OQSSIG_CTX *)vpoqs_sigctx;
...
static int ocsprov_sig_set_ctx_md_params(void *vpoqs_sigctx,
                                     const OSSL_PARAM params[])
{
    PROV_OQSSIG_CTX *poqs_sigctx = (PROV_OQSSIG_CTX *)vpoqs_sigctx;
...
static const OSSL_PARAM *ocsprov_sig_settable_ctx_md_params(void *vpoqs_sigctx)
{
    PROV_OQSSIG_CTX *poqs_sigctx = (PROV_OQSSIG_CTX *)vpoqs_sigctx;
...
const OSSL_DISPATCH oqs_signature_functions[]
    = {{OSSL_FUNC_SIGNATURE_NEWCTX, (void (*)(void))ocsprov_sig_newctx},
       {OSSL_FUNC_SIGNATURE_SIGN_INIT, (void (*)(void))ocsprov_sig_sign_init},
       {OSSL_FUNC_SIGNATURE_SIGN, (void (*)(void))ocsprov_sig_sign},
       {OSSL_FUNC_SIGNATURE_VERIFY_INIT, (void (*)(void))ocsprov_sig_verify_init},
       {OSSL_FUNC_SIGNATURE_VERIFY, (void (*)(void))ocsprov_sig_verify},
       {OSSL_FUNC_SIGNATURE_DIGEST_SIGN_INIT,
        (void (*)(void))ocsprov_sig_digest_sign_init},
       {OSSL_FUNC_SIGNATURE_DIGEST_SIGN_UPDATE,
        (void (*)(void))ocsprov_sig_digest_signverify_update},
       {OSSL_FUNC_SIGNATURE_DIGEST_SIGN_FINAL,
        (void (*)(void))ocsprov_sig_digest_sign_final},
       {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_INIT,
        (void (*)(void))ocsprov_sig_digest_verify_init},
       {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_UPDATE,
        (void (*)(void))ocsprov_sig_digest_signverify_update},
       {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_FINAL,
        (void (*)(void))ocsprov_sig_digest_verify_final},
       {OSSL_FUNC_SIGNATURE_FREECTX, (void (*)(void))ocsprov_sig_freectx},
       {OSSL_FUNC_SIGNATURE_DUPCTX, (void (*)(void))ocsprov_sig_dupctx},
       {OSSL_FUNC_SIGNATURE_GET_CTX_PARAMS,
        (void (*)(void))ocsprov_sig_get_ctx_params},
       {OSSL_FUNC_SIGNATURE_GETTABLE_CTX_PARAMS,
        (void (*)(void))ocsprov_sig_gettable_ctx_params},
       {OSSL_FUNC_SIGNATURE_SET_CTX_PARAMS,
        (void (*)(void))ocsprov_sig_set_ctx_params},
       {OSSL_FUNC_SIGNATURE_SETTABLE_CTX_PARAMS,
        (void (*)(void))ocsprov_sig_settable_ctx_params},
       {OSSL_FUNC_SIGNATURE_GET_CTX_MD_PARAMS,
        (void (*)(void))ocsprov_sig_get_ctx_md_params},
       {OSSL_FUNC_SIGNATURE_GETTABLE_CTX_MD_PARAMS,
        (void (*)(void))ocsprov_sig_gettable_ctx_md_params},
       {OSSL_FUNC_SIGNATURE_SET_CTX_MD_PARAMS,
        (void (*)(void))ocsprov_sig_set_ctx_md_params},
       {OSSL_FUNC_SIGNATURE_SETTABLE_CTX_MD_PARAMS,
        (void (*)(void))ocsprov_sig_settable_ctx_md_params},
       {0, NULL}};