...
# define OPENCA_ALG_PKEY_EXP_DILITHIUMX_NAME    "DilithiumX"
# define OPENCA_ALG_PKEY_EXP_DILITHIUMX_DESC    "DilithiumX"
...
// SIGS - EXP - DILITHIUM
# define OPENCA_ALG_SIGS_EXP_DILITHIUM_OID              OPENCA_ALG_SIGS_EXP_OID ".1"

// SIGS - EXP - DILITHIUM - DILITHIUMX
# define OPENCA_ALG_SIGS_EXP_DILITHIUMX_NULL_OID        OPENCA_ALG_SIGS_EXP_DILITHIUM_OID ".1"
# define OPENCA_ALG_SIGS_EXP_DILITHIUMX_NULL_DESC       "DilithiumXNoHash"
# define OPENCA_ALG_SIGS_EXP_DILITHIUMX_NULL_NAME       "DILITHIUMX-NULL"

# define OPENCA_ALG_SIGS_EXP_DILITHIUMX_SHA256_OID      OPENCA_ALG_SIGS_EXP_DILITHIUM_OID ".2"
# define OPENCA_ALG_SIGS_EXP_DILITHIUMX_SHA256_DESC     "DilithiumXWithSha256"
# define OPENCA_ALG_SIGS_EXP_DILITHIUMX_SHA256_NAME     "DILITHIUMX-SHA256"
...
# define OPENCA_ALG_PKEY_EXP_COMP_DESC_ENTRUST                      "Composite Key"
# define OPENCA_ALG_PKEY_EXP_COMP_NAME_ENTRUST                      "COMPOSITE-KEY"
...
# define OPENCA_ALG_PKEY_EXP_COMP_EXPLICIT_FALCON1024_ECDSA_P521_OID    "2.16.840.1.114027.80.5.5"
# define OPENCA_ALG_PKEY_EXP_COMP_EXPLICIT_FALCON1024_ECDSA_P521_DESC   "id-Falcon1024-ECDSA_P521"
# define OPENCA_ALG_PKEY_EXP_COMP_EXPLICIT_FALCON1024_ECDSA_P521_NAME   "FALCON1024-P512"

# define OPENCA_ALG_PKEY_EXP_COMP_EXPLICIT_FALCON1024_RSA_OID           "2.16.840.1.114027.80.5.6"
# define OPENCA_ALG_PKEY_EXP_COMP_EXPLICIT_FALCON1024_RSA_DESC          "id-Falcon1024-RSA"
# define OPENCA_ALG_PKEY_EXP_COMP_EXPLICIT_FALCON1024_RSA_NAME          "FALCON1024-RSA"
...
# define OPENCA_ALG_PKEY_EXP_COMP_EXPLICIT_SPHINCS256R_ECDSA_P256_NAME  "SPHINCSR-P256"
