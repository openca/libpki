 ...
 * TLSv1.1, and TLSv1.2 */
#define PKI_SSL_CLIENT_ALGOR_ALL TLS_client_method()
...
#  define PKI_SSL_SERVER_ALGOR_TLS1_3	TLSv1_3_server_method()
# else
#  define PKI_SSL_SERVER_ALGOR_TLS1_3	PKI_SSL_SERVER_ALGOR_UNKNOWN
# endif
#else
# define PKI_SSL_SERVER_ALGOR_TLS1_3	PKI_SSL_SERVER_ALGOR_UNKNOWN
#endif
...
#  define PKI_SSL_SERVER_ALGOR_DTLS1_2	DTLSv1_2_server_method()
# else
#  define PKI_SSL_SERVER_ALGOR_DTLS1	PKI_SSL_SERVER_ALGOR_UNKNOWN
# endif
...
/* Generic method that implements all SSLv2, SSLv3, TLSv1.0,
 * TLSv1.1, and TLSv1.2 */
#define PKI_SSL_SERVER_ALGOR_ALL	TLS_server_method()

/* Default Server Method */
#define PKI_SSL_SERVER_ALGOR_DEFAULT PKI_SSL_SERVER_ALGOR_TLS1_3
...
typedef enum {
	...
	PKI_SSL_FLAGS_NO_TLS1_3	= SSL_OP_NO_TLSv1_3,
#else
	PKI_SSL_FLAGS_NO_TLS1_3	= 0,
#endif
