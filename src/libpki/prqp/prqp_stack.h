...
// Stack Declarations for PRQP
DECLARE_OSSL_STACK_FN_DUP(PKI_X509_PRQP_REQ)
DECLARE_OSSL_STACK_FN_DUP(PKI_X509_PRQP_RESP)
DECLARE_OSSL_STACK_FN_DUP(RESOURCE_IDENTIFIER)
DECLARE_OSSL_STACK_FN_DUP(RESOURCE_RESPONSE_TOKEN)
