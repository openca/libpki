...
CRYPTO_DIGEST *PKI_X509_CERT_fingerprint(const PKI_X509_CERT *x,
				      const PKI_DIGEST_ALG *alg );
CRYPTO_DIGEST *PKI_X509_CERT_fingerprint_by_name(const PKI_X509_CERT *x,
					      const char *alg );

/* Key Hash functions */
CRYPTO_DIGEST *PKI_X509_CERT_key_hash(const PKI_X509_CERT *x, 
				   const PKI_DIGEST_ALG *alg );
CRYPTO_DIGEST *PKI_X509_CERT_key_hash_by_name(const PKI_X509_CERT *x, 
					   const char *alg );
