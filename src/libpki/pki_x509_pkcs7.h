...
// Certs
int PKI_X509_PKCS7_add_cert(PKI_X509_PKCS7      * p7,
...
int PKI_X509_PKCS7_add_signer(PKI_X509_PKCS7         * p7,
...
// Cipher
int PKI_X509_PKCS7_set_cipher(PKI_X509_PKCS7   * p7,
...
int PKI_X509_PKCS7_add_recipient(PKI_X509_PKCS7      * p7,
				                 const PKI_X509_CERT * const x);
...
int PKI_X509_PKCS7_add_attribute(PKI_X509_PKCS7 * p7,
...
int PKI_X509_PKCS7_delete_attribute(PKI_X509_PKCS7 * p7,
				                    PKI_ID           id);

int PKI_X509_PKCS7_delete_signed_attribute(PKI_X509_PKCS7 * p7,
					                       PKI_ID           id);
